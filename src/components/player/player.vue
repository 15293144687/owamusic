  ...
  <div class="player" v-show="playList.length>0">
            ...
            <div class="lyric-wrapper">
              <div v-if="currentLyric">
                <p ref="lyricLine"
                   ...
                   :class="{'current':currentLyricLineNum === index}">{{line.txt}}</p>
              </div>
            </div>
          </scroll>
        </div>
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon"><img width="40" height="40" :src="currentSong.image" :class="cdCls"></div>
        <div class="text">
  ...
  export default {
    ...
    computed: {
      ...
      musicUrl() {
        if (this.currentIndex % 2 === 0)
          return 'http://sc1.111ttt.cn:8282/2018/1/03m/13/396131232171.m4a?tflag=1519095601&pin=6cd414115fdb9a950d827487b16b5f97#.mp3';
        else
          return 'http://sc1.111ttt.cn:8282/2017/1/11m/11/304112002072.m4a?tflag=1519095601&pin=6cd414115fdb9a950d827487b16b5f97#.mp3';
      },
      disableCls() {
    ...
    methods: {
      ...
      loop() {
        ...
        this.$refs.audio.play();
        if (this.currentLyric) {
          this.currentLyric.seek();     //把歌词偏移到最开始的地方
        }
      },
      changeMode() {
      ...
      _getPosAndScale() {
        const targetWidth = 40;                     //小图片边长
        const paddingLeft = 40;                     //屏幕左边界到小图片中心距离20+20
        const paddingBottom = 30;                   //屏幕下边界到小图片中心距离20+10
        const paddingTop = 80;                      //大图片 顶部到屏幕顶部距离
        const width = window.innerWidth * 0.8;      //大图片边长
